...
See [CONTRIBUTING.md](CONTRIBUTING.md). Work is planned spec-first in `.ai/sdd/specs/` — completed tasks carry verification evidence, open tasks are up for grabs.
